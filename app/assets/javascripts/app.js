...
app.controller('AppCtrl', ['$scope', '$mdBottomSheet','$mdSidenav', '$mdDialog', '$http', '$window', '$document', 'FlickityService', '$timeout', function($scope, $mdBottomSheet, $mdSidenav, $mdDialog, $http, $window, $document, FlickityService, $timeout){
  ...
  $scope.activity = [
      {
        author: 'TNW Deals',
        title: 'Clean up and protect your devices with 2TB of ultra-secure cloud storage — only $59.99',
        when: '2017-07-02T17:33:02Z',
        imageUrl: "https://cdn3.tnwcdn.com/wp-content/blogs.dir/1/files/2017/07/JgYix8H.jpg",
        link: "https://thenextweb.com/offers/2017/07/02/clean-protect-devices-2tb-ultra-secure-cloud-storage-59-99/"
      },
      {
        author: 'TNW Deals',
        title: 'Be a digital entrepreneur – and do it the right way for only $39',
        when: '2017-07-02T17:33:02Z',
        imageUrl: "https://cdn3.tnwcdn.com/wp-content/blogs.dir/1/files/2017/07/mfOopaP.jpg",
        link: "https://thenextweb.com/offers/2017/07/01/digital-entrepreneur-right-way-39/"
      },
      {
        author: 'Bryan Clark',
        title: 'Is this the iPhone 8? Sure looks like it',
        when: '2017-07-02T17:33:02Z',
        imageUrl: "https://cdn2.tnwcdn.com/wp-content/blogs.dir/1/files/2017/07/Screenshot-2017-06-14-at-01.13.11-1200x701.png",
